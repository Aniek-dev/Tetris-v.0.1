import { BoardHold, BoardTetris, BoardNext } from "/scripts/boardTetris.js";
    ...
    rotationTetrominoCW(){
     ...
     placeTetromino(){
        ...
        for(let i = 0; i < tetrominoPosition.length; i++){
            this.BoardTetris.matriz
              ...
              [tetrominoPosition[i].column] = this.currentTetromino.id;
        }
     ...
     drawTetrominoGhost(){
        ...
        for(let i = 0; i<tetrominoPositions.length; i++){
           ...
           //draw block ghost 
           this.BoardTetris.drawSquare(position.x,position.y,this.BoardTetris.cellSize,"#f3ebeb41","white",20);
        }
     }
     dropBlock(){
     ...
     holdTetromino(){
        ...
        this.currentTetromino.reset();
         ...
         this.currentTetromino.position.row = 0;
    this.currentTetromino.position.column = Math.floor(this.BoardTetris.cols / 2) - 1;
